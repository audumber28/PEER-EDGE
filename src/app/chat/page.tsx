    ...
    <div className="fixed inset-0 bg-black flex flex-col">
      ...
      <div className="bg-[#1E1E1E] p-4 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <img src="im1.jpg" alt="Profile" className="rounded-full w-10 h-10" />
          <div>
        ...
        {messages.map((message) => (
          ...
          >
            ...
            >
              ...
              <div className="text-sm text-slate-900 text-right mt-2">
                {message.timestamp}
              </div>
            </div>
          </div>
      ...
      <div className="bg-[#1E1E1E] p-4 flex items-center space-x-2">
        ...
        <button
          ...
          className="bg-green-600 text-black p-2 rounded-full"
        >
          <Send size={20} />
        </button>
      </div>
