        ...
        <>
            <p
                className={`flex ${reverseOrder ? 'flex-row-reverse' : ''
                    } justify-between items-center p-2 cursor-pointer text-gray-500 ${purple ? 'text-dark-enmity' : ''
                    } ${red ? 'text-red-500' : ''} rounded-md hover:bg-dark-enmity ${red ? 'hover:bg-red-500' : ''
